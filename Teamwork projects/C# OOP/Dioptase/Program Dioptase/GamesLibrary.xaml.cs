namespace ProgramDioptase
{
    ...
    public partial class GamesLibrary : Window
    {
        public GamesLibrary()
        {
            this.InitializeComponent();
            ElementRenderer.VisualizeAllElementsToPanel<Game>(this.AllGamesPanel, App.Resources.Games);
        }
        ...
        {
            ElementRenderer.VizualizeNewSearchResultByName<Game>(this.AllGamesPanel, this.SearchBox, App.Resources.Games);
        ...
        private void OnCheckBoxSelection(object sender, RoutedEventArgs e)
        {
            if (!string.IsNullOrEmpty(this.SearchBox.Text) && this.SearchBox.Text != "Search by name")
            {
                ElementRenderer.VizualizeItemsBySelectedGenres(
                    this.AllGamesPanel, this.GenrePanel, App.Resources.Games, this.SearchBox.Text);
            }
            else
            {
                ElementRenderer.VizualizeItemsBySelectedGenres(
                    this.AllGamesPanel, this.GenrePanel, App.Resources.Games);
            }
        }
