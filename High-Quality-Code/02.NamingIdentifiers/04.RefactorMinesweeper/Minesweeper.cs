    ...
    public class Minesweeper
    {
        public static void Main()
        {
            ...
            do
            {
                if (isStartGame)
                {
                    Console.WriteLine("Let's play 'Minesweepers'. Try your luck by stepping only on the mine-free fields.\n" +
                    "Command 'top' shows the highscores, 'restart' starts a new game, 'exit' quits the game!");
                    PrintPlayground(gameFiled);
                    isStartGame = false;
                }

                Console.Write("Enter row and column, separated by [space] (example: 2 3): ");
