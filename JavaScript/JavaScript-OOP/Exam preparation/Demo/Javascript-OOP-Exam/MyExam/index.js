...
var media = module.getMedia('ECCC', 2, 13, 'Stavai i se mahai');
var media2 = module.getMedia('Ribari', 4, 52, 'Hodi hodi');
var mediaCatalog = module.getMediaCatalog('Az sum Gosho');
