    ...
    var module = (function () {
        ...
        validator = {
            ...
            validateString: function (value, name) {
                ...
                if (value.length < CONSTANTS.TEXT_MIN_LENGTH || value.length > CONSTANTS.TEXT_MAX_LENGTH) {
...
//for (var i = 0; i < 10; i++) {
//    var currentVideo = module.getVideo('Video ' + i, 'Author ' + i, 4);
...
playlist
    .addPlayable(someAudio)
    .addPlayable(anotherAudio)
    .addPlayable(anotherAudio2);
